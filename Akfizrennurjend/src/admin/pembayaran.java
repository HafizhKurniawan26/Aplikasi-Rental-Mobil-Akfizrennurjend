...
public class pembayaran extends javax.swing.JFrame {
    ...
    public void tampilkanPembayaran() {
        ...
        String sql = "SELECT id_pembayaran, id_rental, metode_pembayaran, jumlah_bayar, tanggal_bayar, status FROM pembayaran";
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            int idPembayaran = (int) jTable1.getValueAt(selectedRow, 0); // ambil ID di kolom 0
            ...
            try (Connection conn = databaseConnection.connect();
                ...
                tampilkanPembayaran(); // refresh tabel
            } catch (Exception ex) {
